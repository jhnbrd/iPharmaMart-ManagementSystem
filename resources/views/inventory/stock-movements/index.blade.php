<x-layout title="Stock Movements">
    ...
    <div class="page-header">
        <div class="flex items-center justify-between w-full">
            <div>
                ...
                <p class="text-[var(--color-text-secondary)] mt-1">Track all stock in and stock out transactions</p>
            </div>
            <div class="flex gap-2">
                ...
                <a href="{{ route('inventory.stock-movements.create') }}" class="btn btn-primary">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div id="filters-section" class="bg-white border border-[var(--color-border-light)] mb-6 hidden">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('inventory.stock-movements.index') }}"
                ...
                <div class="form-group mb-0">
                    ...
                    <a href="{{ route('inventory.stock-movements.index') }}" class="btn btn-secondary">Clear</a>
                </div>
            </form>
        </div>
    </div>
