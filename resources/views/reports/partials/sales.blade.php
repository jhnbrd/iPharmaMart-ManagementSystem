...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
    <div class="bg-white p-6 border-l-4 border-[var(--color-brand-green)] shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm text-gray-600 uppercase tracking-wide">Total Sales</p>
            </div>
            <div class="text-right">
                <p class="text-3xl font-bold text-[var(--color-brand-green)]">
                    ₱{{ number_format($data['totalRevenue'], 2) }}</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                <p class="text-3xl font-bold text-[var(--color-accent-blue)]">
                    {{ number_format($data['totalTransactions']) }}</p>
            </div>
        </div>
    </div>
    <div class="bg-white p-6 border-l-4 border-[var(--color-accent-orange)] shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm text-gray-600 uppercase tracking-wide">Average Transaction</p>
            </div>
            <div class="text-right">
