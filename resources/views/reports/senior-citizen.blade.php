<x-layout title="Senior Citizen Report">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="text-[var(--color-text-secondary)] mt-1">Monthly report of senior citizen discount transactions</p>
        </div>
    ...
    <div class="bg-white border border-[var(--color-border-light)] mb-6 print-hide">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('reports.senior-citizen') }}" class="flex flex-wrap gap-4 items-end">
    ...
    <div class="print-only text-center mb-6">
        ...
        <h2 class="text-xl font-semibold mt-2">Senior Citizen Discount Report</h2>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="text-xs text-[var(--color-text-secondary)]">
                                    ({{ \Carbon\Carbon::parse($transaction->sc_birthdate)->age }} yrs)
                                </span>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="text-center py-8 text-[var(--color-text-secondary)]">
                                No senior citizen transactions found for this month
                            </td>
                        </tr>
                    @endforelse
                </tbody>
