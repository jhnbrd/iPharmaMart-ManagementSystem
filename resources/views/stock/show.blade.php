<x-layout title="Stock Movement Details"
    subtitle="Movement #{{ $stockMovement->id }} - {{ $stockMovement->created_at->format('M d, Y h:i A') }}">
    <!-- Page Header -->
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 font-semibold">{{ $stockMovement->created_at->format('M d, Y h:i A') }}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">{{ $stockMovement->created_at->diffForHumans() }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 font-semibold">₱{{ number_format($stockMovement->product->price, 2) }}
                                </p>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                @if ($stockMovement->batch->manufacture_date)
                                    <div>
                                        ...
                                        <p class="mt-1">
                                            {{ $stockMovement->batch->manufacture_date->format('M d, Y') }}
                                        </p>
                                    </div>
                                @endif
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 font-semibold">{{ number_format($stockMovement->batch->quantity) }}
                                    </p>
                                </div>
                            </div>
                        </div>
